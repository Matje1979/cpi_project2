...
admin.site.register(Publikacija)
admin.site.register(Fotografija)
admin.site.register(ClanTima)
admin.site.register(VideoKlip)
admin.site.register(PressClanak)
admin.site.register(Prijava)
admin.site.register(IstorijskaTura)
admin.site.register(Izlozba)
admin.site.register(ArhivskiMaterijal)
